    ...
    testimonials: [
      {
        ...
        name: 'Placeholder Name',
        role: 'Student, Project 28 Participant',
      },
      {
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mt-8 grid gap-6 sm:grid-cols-2">
          {detail.testimonials.map((t, i) => (
            <div
              key={i}
              className="reveal relative flex flex-col rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-100"
            >
              <FaQuoteRight
                className={`absolute right-6 top-6 ${detail.text || 'text-gray-300'}`}
                size={20}
                aria-hidden="true"
              />
              <blockquote className="pr-8 text-sm sm:text-base leading-relaxed text-gray-600">
                &ldquo;{t.quote}&rdquo;
              </blockquote>
              <footer className="mt-5 flex items-center gap-3">
                <FaUserCircle className="shrink-0 text-gray-300" size={40} aria-hidden="true" />
