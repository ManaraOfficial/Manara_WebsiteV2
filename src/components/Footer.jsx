...
function Footer() {
  ...
  return (
    <footer className="border-t border-gray-200 bg-gray-50 text-gray-600">
      {/* Two columns from the smallest screens up, so Quick Links and Contact sit
          side by side instead of stacking into a long scroll. */}
      <div className="mx-auto grid max-w-6xl grid-cols-2 gap-x-6 gap-y-10 px-6 py-12 sm:py-16 lg:grid-cols-[1.5fr_1fr_1.2fr]">
        {/* Brand */}
          ...
          <ul className="mt-4 space-y-3 text-sm">
            <li className="flex items-start gap-2.5 sm:gap-3">
              ...
              <a
                ...
                className="break-words transition-colors hover:text-[#EC8134]"
              >
                {CONTACT_EMAIL}
              </a>
            </li>
      ...
      <div className="border-t border-gray-200">
        <div className="mx-auto flex max-w-6xl flex-col items-center gap-2 px-6 py-5 text-center text-xs text-gray-400 sm:flex-row sm:justify-between sm:text-left">
          <span>
